...
def upgrade():
    ...
    sa.Column('rating', sa.Integer(), nullable=True),  # Nueva columna agregada
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('rating', sa.Integer(), nullable=True),  # Crea la columna rating
    sa.Column('numRatings', sa.Integer(), nullable=True),
    sa.Column('totalRatings', sa.Float(), nullable=True),
